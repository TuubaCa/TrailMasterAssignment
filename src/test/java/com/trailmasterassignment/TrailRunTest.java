...
public class TrailRunTest {
    ...
    public void setup() {
        ...
        trailRun = new TrailRun("RUN-001", distance, durationInSeconds, date);
    }
    ...
    public void shouldStoreCorrectInformation() {
        ...
        assertEquals("RUN-001", trailRun.getRunIdentifier(), "RunIdentifier is not stored correctly");
    }
    ...
    public void shouldSetDefaultDateIfNull() {
        ...
        TrailRun runWithoutDate = new TrailRun("RUN-002", 12.0, 3600, (Date) null);
    ...
    /**
     * Helper method to create a Date object for a specific year, month, and day.
     *
     * @param year  Year
