...
public class UserTest {
    ...
    public void shouldAddRunAndUpdateValues() {
        ...
        TrailRun newRun = new TrailRun("RUN-001", 10.0, 3600, Date.valueOf(LocalDate.of(2025, 1, 8)));
        user.addRun(newRun);
    ...
    public void averageDistanceShouldBeCorrect() {
        ...
        TrailRun run1 = new TrailRun("RUN-001", 10.0, 3600, Date.valueOf(LocalDate.of(2025, 1, 8)));
        TrailRun run2 = new TrailRun("RUN-002", 5.0, 1800, Date.valueOf(LocalDate.of(2025, 1, 10)));
    ...
    public void fitnessScoreShouldNotBeNegative() {
        ...
        TrailRun oldRun = new TrailRun("RUN-003", 8.0, 2400, Date.valueOf(LocalDate.of(2025, 1, 1)));
        user.addRun(oldRun);
